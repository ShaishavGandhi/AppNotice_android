...
import com.evidon.privacy.appnoticesdk.model.Tracker;
import com.evidon.privacy.appnoticesdk.utils.ImageDownloader;
...
public class TrackerDetail_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.evidon_fragment_tracker_detail, container, false);
        ...
        if (tracker != null) {
            ...
            if (textView_learn_more_url != null && isUrlValid) {
                ...
                textView_learn_more.setText(getResources().getString(R.string.evidon_tracker_detail_learnmore));
                ...
                textView_learn_more.setText(getResources().getString(R.string.evidon_tracker_detail_learnmore_not_provided));
    ...
    public void onResume() {
        ...
        getActivity().setTitle(tracker.getName());  // (R.string.evidon_tracker_detail_title);
    }
