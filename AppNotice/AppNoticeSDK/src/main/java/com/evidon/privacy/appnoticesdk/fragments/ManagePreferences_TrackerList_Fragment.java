...
import com.evidon.privacy.appnoticesdk.adapter.TrackerArrayAdapter;
...
public class ManagePreferences_TrackerList_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.evidon_fragment_manage_preferences_trackerlist, container, false);
        ...
        if (preferencesTrackerMessage != null) {
            if (isEssential) {
                preferencesTrackerMessage.setText(R.string.evidon_preferences_essential_message);
            } else {
                preferencesTrackerMessage.setText(R.string.evidon_preferences_optional_message);
            }
        }
