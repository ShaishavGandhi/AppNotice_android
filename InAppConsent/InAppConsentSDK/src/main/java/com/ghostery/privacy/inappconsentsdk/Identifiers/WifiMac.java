 ...
 * Gets the WIFI MAC address hashed with MD5 and formatted as a 32 byte hexadecimal number. Gets the WIFI MAC address
...
public class WifiMac implements IdentifierSource {
    ...
    public List<TypedIdentifier> get(Context context) {
        ...
        if (wifiMac != null) {
            ...
            ids.add(new TypedIdentifier(TypedIdentifier.TYPE_WIFI_MAC_MD5, ""));
            ids.add(new TypedIdentifier(TypedIdentifier.TYPE_WIFI_MAC_SHA1, ""));
        }
        return (ids);
    }
}
